	...
	private function __construct() {
		...
		if ( is_user_logged_in() ) {
			...
			$config = array(
				...
				'api_url'            => 'https://api.github.com/repos/tuyuribr/proelements',
				'raw_url'            => 'https://raw.githubusercontent.com/tuyuribr/proelements/master',
				'github_url'         => 'https://github.com/tuyuribr/proelements',
				'zip_url'            => 'https://github.com/tuyuribr/proelements/archive/v{release_version}.zip',
				'sslverify'          => true,
				'requires'           => '5.0',
				'tested'             => '5.4.2',
				'readme'             => 'README.md',
